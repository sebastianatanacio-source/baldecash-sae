...
export default async function AgenteHistoricoPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <AgenteView snapshot={ctx.snapshot} config={ctx.config} agenteSlug={ctx.slug} vista="historico" />;
}
