...
export default async function AgenteRendimientoPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <AgenteView snapshot={ctx.snapshot} config={ctx.config} agenteSlug={ctx.slug} vista="rendimiento" />;
}
